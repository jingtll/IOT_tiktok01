export declare const Rate: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
...
export default Rate;
export { rateProps } from 'vant/lib/rate/Rate';
export type { RateProps } from 'vant/lib/rate/Rate';
export type { RateThemeVars } from 'vant/lib/rate/types';
declare module 'vue' {
