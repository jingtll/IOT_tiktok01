...
export declare const timePickerProps: {
    ...
    filter: PropType<(columnType: string, options: import("vant/lib/picker").PickerOption[], values: string[]) => import("vant/lib/picker").PickerOption[]>;
    formatter: {
        type: PropType<(type: string, option: import("vant/lib/picker").PickerOption) => import("vant/lib/picker").PickerOption>;
        default: (type: string, option: import("vant/lib/picker").PickerOption) => import("vant/lib/picker").PickerOption;
    };
} & {
    minHour: {
        type: (NumberConstructor | StringConstructor)[];
...
declare const _default: import("vue").DefineComponent<ExtractPropTypes<{
    ...
    formatter: (type: string, option: import("vant/lib/picker").PickerOption) => import("vant/lib/picker").PickerOption;
    modelValue: string[];
    readonly: boolean;
    loading: boolean;
    allowHtml: boolean;
