export declare const NavBar: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
...
export { navBarProps } from 'vant/lib/nav-bar/NavBar';
export type { NavBarProps } from 'vant/lib/nav-bar/NavBar';
export type { NavBarThemeVars } from 'vant/lib/nav-bar/types';
declare module 'vue' {
