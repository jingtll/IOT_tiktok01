export declare const BackTop: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
...
export { backTopProps } from 'vant/lib/back-top/BackTop';
export type { BackTopProps } from 'vant/lib/back-top/BackTop';
export type { BackTopThemeVars } from 'vant/lib/back-top/types';
declare module 'vue' {
