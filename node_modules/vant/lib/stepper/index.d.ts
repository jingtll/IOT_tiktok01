export declare const Stepper: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    min: {
    ...
    theme: import("vue").PropType<import("vant/lib/stepper/Stepper").StepperTheme>;
...
export { stepperProps } from 'vant/lib/stepper/Stepper';
export type { StepperTheme, StepperProps } from 'vant/lib/stepper/Stepper';
export type { StepperThemeVars } from 'vant/lib/stepper/types';
declare module 'vue' {
