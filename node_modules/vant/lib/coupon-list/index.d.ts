export declare const CouponList: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    code: {
        type: import("vue").PropType<string>;
        default: string;
    };
    coupons: {
        type: import("vue").PropType<import("vant").CouponInfo[]>;
        default: () => never[];
    };
    currency: {
        type: import("vue").PropType<string>;
    ...
    code: string;
    currency: string;
    coupons: import("vant").CouponInfo[];
    chosenCoupon: number | number[];
    showCount: boolean;
    disabledCoupons: import("vant").CouponInfo[];
...
export { couponListProps } from 'vant/lib/coupon-list/CouponList';
export type { CouponListProps } from 'vant/lib/coupon-list/CouponList';
export type { CouponListThemeVars } from 'vant/lib/coupon-list/types';
declare module 'vue' {
