...
import type { FieldRule, FieldType, FieldTextAlign, FieldClearTrigger, FieldFormatTrigger, FieldAutosizeConfig, FieldEnterKeyHint } from 'vant/lib/field/types';
...
export declare const fieldProps: {
    ...
    size: PropType<import("vant/lib/cell").CellSize>;
    ...
    arrowDirection: PropType<import("vant/lib/cell").CellArrowDirection>;
    required: {
