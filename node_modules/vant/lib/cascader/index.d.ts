export declare const Cascader: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    fieldNames: import("vue").PropType<import("vant/lib/cascader/types").CascaderFieldNames>;
...
export { cascaderProps } from 'vant/lib/cascader/Cascader';
export type { CascaderProps } from 'vant/lib/cascader/Cascader';
export type { CascaderOption, CascaderThemeVars, CascaderFieldNames, } from 'vant/lib/cascader/types';
declare module 'vue' {
