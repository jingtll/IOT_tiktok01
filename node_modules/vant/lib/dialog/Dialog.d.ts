...
import type { DialogTheme, DialogAction, DialogMessage, DialogMessageAlign } from 'vant/lib/dialog/types';
export declare const dialogProps: {
    ...
    beforeClose: PropType<import("vant/lib/utils").Interceptor>;
    overlayProps: PropType<Partial<import("vant").OverlayProps>>;
