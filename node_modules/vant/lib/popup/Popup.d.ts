...
import type { PopupPosition, PopupCloseIconPosition } from 'vant/lib/popup/types';
export declare const popupProps: {
    ...
    overlayProps: import("vue").PropType<Partial<import("vant/lib/overlay").OverlayProps>>;
