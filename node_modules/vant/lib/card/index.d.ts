export declare const Card: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
...
export default Card;
export { cardProps } from 'vant/lib/card/Card';
export type { CardProps } from 'vant/lib/card/Card';
export type { CardThemeVars } from 'vant/lib/card/types';
declare module 'vue' {
