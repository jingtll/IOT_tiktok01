import { PickerGroupProps } from 'vant/lib/picker-group/PickerGroup';
export declare const PickerGroup: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    tabs: {
...
export { pickerGroupProps } from 'vant/lib/picker-group/PickerGroup';
export type { PickerGroupProps };
export type { PickerGroupThemeVars } from 'vant/lib/picker-group/types';
declare module 'vue' {
