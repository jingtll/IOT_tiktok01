import { AddressEditProps } from 'vant/lib/address-edit/AddressEdit';
export declare const AddressEdit: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    searchResult: import("vue").PropType<import("vant/lib/address-edit/types").AddressEditSearchItem[]>;
    ...
    addressInfo: {
        type: import("vue").PropType<Partial<import("vant/lib/address-edit/types").AddressEditInfo>>;
        default: () => import("vant/lib/address-edit/types").AddressEditInfo;
    };
    telValidator: {
    ...
    addressInfo: Partial<import("vant/lib/address-edit/types").AddressEditInfo>;
    telValidator: (val: string) => boolean;
}, {}, {}, {}, string, import("vue").ComponentProvideOptions, true, {}, any>>;
export default AddressEdit;
export { addressEditProps } from 'vant/lib/address-edit/AddressEdit';
export type { AddressEditProps };
export type { AddressEditInfo, AddressEditInstance, AddressEditThemeVars, AddressEditSearchItem, } from 'vant/lib/address-edit/types';
declare module 'vue' {
