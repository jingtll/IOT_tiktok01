export declare const PullRefresh: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
...
export { pullRefreshProps } from 'vant/lib/pull-refresh/PullRefresh';
export type { PullRefreshProps } from 'vant/lib/pull-refresh/PullRefresh';
export type { PullRefreshThemeVars } from 'vant/lib/pull-refresh/types';
declare module 'vue' {
