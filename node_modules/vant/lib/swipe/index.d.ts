import { SwipeProps } from 'vant/lib/swipe/Swipe';
export declare const Swipe: import("vant/lib/utils").WithInstall<import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    loop: {
...
export { swipeProps } from 'vant/lib/swipe/Swipe';
export type { SwipeProps };
export type { SwipeInstance, SwipeToOptions, SwipeThemeVars } from 'vant/lib/swipe/types';
declare module 'vue' {
